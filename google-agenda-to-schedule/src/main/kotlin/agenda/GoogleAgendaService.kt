...
class GoogleAgendaService {
  ...
  private fun authorize(): Credential {
    ...
    if (secrets.size < 2) {
      ...
      val accessToken = (secrets["auth"] as ArrayMap<*, *>).getValue(0)
      val refreshToken = (secrets["auth"] as ArrayMap<*, *>).getValue(1)
      ...
      credential.accessToken = accessToken as String
      credential.refreshToken = refreshToken as String
